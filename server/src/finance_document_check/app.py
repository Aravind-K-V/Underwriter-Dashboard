...
class LightweightFieldMatcher:
    ...
    def __init__(self):
        ...
        self.document_expected_fields = {
            ...
            "pan document": ["name", "pan_number", "dob"],  
    ...
    def extract_fields_from_json(self, json_data: Union[dict, list], document_type: str = None) -> dict:
        ...
        try:
            ...
            expected_fields = self.document_expected_fields.get(document_type_lower, ["name", "pan_number"])
            ...
            if document_type_lower in ["pan", "pan card", "pan document"]:
                # PAN: Extract name, pan_number, dob ONLY
            ...
            expected_fields = self.document_expected_fields.get(document_type.lower() if document_type else "pan", ["name", "pan_number"])
            return {field: None for field in expected_fields}
...
def process_idp_response(idp_response, document_type, document_id):
    ...
    try:
        ...
        expected_fields = field_matcher.document_expected_fields.get(document_type.lower(), ["name", "pan_number"])
        return {field: None for field in expected_fields}
        ...
        if doc_record["extracted_data"] is not None and doc_record["extracted_data"].strip() != "":
            ...
            try:
                ...
                if proposer_result:
                    ...
                    expected_fields = field_matcher.document_expected_fields.get(doc_record["document_type"].lower(), ["name", "pan_number"])
